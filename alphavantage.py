...
def alphavantage_analytics():
    ...
    url = 'https://alphavantageapi.co/timeseries/analytics?SYMBOLS='+symbols+'&RANGE=2023-07-01&RANGE=2023-08-31&INTERVAL=DAILY&OHLC=close&CALCULATIONS=MEAN,STDDEV,CORRELATION&apikeyd=demo'
    r = requests.get(url)
